...
export function Avatar({ initials, color, avatarUrl, online, size = 40, showStatus = true, isGroup, ringClassName = 'border-surface-elevated' }: AvatarProps) {
  return (
    <div className="relative shrink-0" style={{ width: size, height: size }}>
      {avatarUrl ? (
        // eslint-disable-next-line @next/next/no-img-element
        <img src={avatarUrl} alt="" className="h-full w-full rounded-full object-cover" style={{ width: size, height: size }} />
      ) : (
        <div
